...
namespace SwfDotNet.IO.Samples.Effects.Translation
{
	/// <summary>
	/// Translation
	/// </summary>
	class Translation
	{
		...
		static void Main(string[] args)
		{
            ...
            string path = "test_translation.swf";
            //Alpha translation informations
            int moveFrameNum = 20; //frame duration
            int posX = 200;
            int posY = 200;
            int endPosX = 100;
            int endposY = 50;
            ...
            swf.Tags.Add(new PlaceObject2Tag(shapeTag.CharacterId, 1, -20 * 20, -20 * 20, true));
            //Add a frame
            swf.Tags.Add(new ShowFrameTag());

            swf.Tags.Add(new PlaceObject2Tag(shapeTag.CharacterId, 1, -60 * 20, -60 * 20, true));
            //Add a frame
            swf.Tags.Add(new ShowFrameTag());

            swf.Tags.Add(new PlaceObject2Tag(shapeTag.CharacterId, 1, -100 * 20, -100 * 20, true));
            //Add a frame
            swf.Tags.Add(new ShowFrameTag());
